...
export class SubEventResourcePopupController {
  ...
  private readonly eventResourcePopupHost: EventResourcePopupHost = {
    ...
    resourceTypeClass: type => AssetDefaultsBuilder.assetTypeClass(type === 'Members' ? 'Car' : type),
    resourceTypeIcon: type => type === 'Members' ? 'groups' : AssetDefaultsBuilder.assetTypeIcon(type),
