...
import { ASSETS_TABLE_NAME, type AssetsRecordCollection } from '../../base/models/assets.model';
...
import { LocalSeedScheduleBuilder, LocalUserSeedBuilder } from '../builders';
...
export class LocalActivityResourcesRepository extends HttpActivityResourcesRepository {
  ...
  private buildSeededRecordsForUser(
    ...
    const nextRecords: ActivitySubEventResourceRecord[] = [];
    let createdMs = LocalSeedScheduleBuilder.anchorDate().getTime();
