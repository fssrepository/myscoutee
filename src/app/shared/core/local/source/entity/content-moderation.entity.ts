...
export interface ContentModerationTable extends ContentModerationSnapshot { items: Record<string, ContentModerationItem>; }
...
export function emptyContentModeration(): ContentModerationTable {
  return { revision: 0, settings: { autoApprove: true, delayMinutes: 0, categories: ['asset', 'event', 'feed'] }, counts: {}, pendingCount: 0, items: {} };
}
