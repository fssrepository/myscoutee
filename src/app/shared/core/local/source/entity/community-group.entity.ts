...
export type CommunityGroupRecord = Pick<CommunityGroup, 'id' | 'ownerUserId' | 'name' | 'description' | 'imageUrl'
  | 'category' | 'visibility' | 'hideMembers' | 'policy' | 'createdAtIso' | 'updatedAtIso' | 'version' | 'moderationStatus' | 'moderationPending' | 'moderationQueueRevision'> & { pendingMembers?: number; lifecycleStatus?: 'active' | 'under-review' | 'deleted' | null; ownerReleasedAtIso?: string | null; takeoverCandidates?: string[] | null };
