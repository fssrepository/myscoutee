...
export class SeedAssetsRepository {
  ...
  seedDefaults(ownerUserIds?: readonly string[], seedUsers: readonly UserDto[] = []): Map<string, AppTypes.AssetCard[]> {
  ...
  private toAssetCard(record: AssetRecord): AppTypes.AssetCard {
    return {
      ...record,
