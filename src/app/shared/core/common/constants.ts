...
// Activity
export const ACTIVITY_MEMBER_STATUSES = ['pending', 'accepted', 'disqualified', 'removed', 'deleted'] as const;
...
export const ASSET_REQUEST_ACTIONS = ['accept', 'remove', 'makeManager', 'revokeManager', 'manage'] as const;
