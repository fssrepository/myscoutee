...
import type { DemoCountryPartition } from '../models/country-partitions.model';

const DEMO_COUNTRY_PARTITIONS: readonly DemoCountryPartition[] = [
  {
...
export class DemoCountryPartitionsRepository {
  queryPartitionByCountryCode(countryCode: string | null | undefined): DemoCountryPartition | null {
