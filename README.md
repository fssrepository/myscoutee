...
The MyScoutee 1.0.1 Debian installer, client tools, checksums and signed release
metadata are available from the
[v1.0.1 GitHub release](https://github.com/fssrepository/myscoutee/releases/tag/v1.0.1).
