...
The MyScoutee 1.0.2 client tools, partial-update prerequisites, container
references, checksums and signed metadata are available from the
[v1.0.2 GitHub release](https://github.com/fssrepository/myscoutee/releases/tag/v1.0.2).
The Debian installer upload is handled separately by the release owner.
